...
class DownloadsController extends Controller
{
  ...
  private $frontRows;
  private $adminId;
  public function __construct(Downloads $model){

    $this->parentRoute = 'downloads';
    $this->titleType   = trans('admin.download');
    $this->postCount   = 20;
    ...
    $this->msgs        = [
                          ...
                          'content.required' => trans('admin_auth.contentRequired'),
                        ];
