...
class ProgramsController extends Controller
{
  ...
  public function __construct(Program $model){
    ...
    $this->parentRoute = 'programs';
    $this->titleType   = trans('admin.program');
    $this->postCount   = 20;
    ...
    $this->frontRows = [ 'title','image', 'file' ];
