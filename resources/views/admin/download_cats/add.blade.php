...
@section('header')
<link href="{{asset('styleassets/plugins/dropify/dist/css/dropify.min.css')}}" rel="stylesheet">
<link href="{{asset('styleassets/plugins/icheck/skins/all.css')}}" rel="stylesheet">
...
<div class="card">
    <div class="card-block">
        {!! Form::open(['class' => 'floating-labels m-t-40', 'route'=> $parentroute . '.store', 'files' => true]) !!}
            ...
            <div class="form-group m-b-40">
                <a href="http://image-map.weebly.com/" class="btn btn-info" target="_blank"> اضغط هنا لبناء خطة </a>
            </div>
            <div class="form-group m-b-40">
                <textarea name="code" class="form-control input-sm">{{old('code')}}</textarea><span class="bar"></span>
