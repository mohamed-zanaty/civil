    ...
    <div class="card-block">
        {!! Form::open(['class' => 'floating-labels m-t-40', 'route'=> $parentroute . '.store', 'files' => true]) !!}
            ...
            <div class="form-group m-b-40">
              ...
              <textarea  class="form-control input-sm" name="sdesc" required>{{old('sdesc')}}</textarea><span class="bar"></span>
            </div>


            <div class="form-group m-b-40">
                <input type="text" class="form-control input-sm" name="file" required value="{{old('file')}}"><span class="bar"></span>
