...
<div class="card">
    <div class="card-block">
        {!! Form::open(['class' => 'floating-labels m-t-40', 'url' => 'admin/' . $parentroute . '/' . $result->id, 'method' => 'PUT', 'files' => true]) !!}
          ...
          <div class="form-group m-b-40">
            <label class="clabel">الوصف</label>
            <textarea  class="form-control input-sm" name="sdesc" required>{{$result->sdesc}}</textarea><span class="bar"></span>
          </div>


          <div class="form-group m-b-40">
              <input type="text" class="form-control input-sm" name="file" required value="{{$result->file}}"><span class="bar"></span>
              <label for="input8">رابط ملف التحميل</label>
          </div>
...
@section('footer')
<script src="{{asset('styleassets/plugins/ckeditor/ckeditor.js')}}"></script>
...
<script src="{{asset('styleassets/plugins/dropify/dist/js/dropify.min.js')}}"></script>
<script>
