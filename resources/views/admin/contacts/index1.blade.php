                ...
                <tbody>
                  ...
                  @foreach($results as $number => $result)
                    <tr >
                        ...
                        <td>
                            <a href="{{$parentroute}}/{{$result->id}}/edit" type="button" class="btn btn-sm btn-icon btn-pure btn-outline delete-row-btn" data-toggle="tooltip" data-original-title="{{trans('admin.view')}}"><i class=" ti-eye " aria-hidden="true"></i></a>
