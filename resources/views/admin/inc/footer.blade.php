...
<div class="right-sidebar">
    <div class="slimscrollright">
        <div class="rpanel-title"> قائمة الالوان <span><i class="ti-close right-side-toggle"></i></span> </div>
...
<!-- ============================================================== -->
<footer class="footer">
 2017 © <a href="http://alfarisprojects.com/"> الفارس</a>
</footer>
<!-- ============================================================== -->
<!-- End footer -->
<!-- ============================================================== -->
...
@yield('footer')
<script src="{{ADMINSTYLE}}/js/script.js"></script>
</body>
